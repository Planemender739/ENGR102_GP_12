...
#(i)
x=(e**2*(+log(19.000))**2)/(2025.0+8.0**3.0)
x=(((e**2)+log(19))**2)/(2025+8**3)
print(x)

#1b
#calculate 12natural log of 49 plus tangent of 2pi/3
y=y.evalf(12*log(49)+tan(2*pi/3))  #This is the decimal answer
z=(12*log(49)+tan(2*pi/3))       #This is the exact answer
print("The decimal approximation is",y)
print("The exact answer is",z)
...
#R9 is the monthly payment with a term of 9 years
R9=P*((r/m)*(1+(r/m))**(m*t))/((1+(r/m))**(m*t)-1)
print(R9)

t=7 
#R7 is the monthly payment with a term of 7 year
